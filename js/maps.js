...
function createNassau() {
  ...
  // Sand around the dock house / first house of Nassau so the shoreline there is beach rather than water.
  paintRect(ground, 7, 18, 6, 6, "sand");
  // Small southern jetty / start point.
  paintRect(ground, 21, 24, 3, 3, "sand");
  ...
  return {
    ...
    objects: [
      ...
      },
      {
        id: "dock",
        sprite: "boat",
        // Single-tile dock placed at the south start tile.
        x: 22,
        y: 25,
        drawW: 48,
        drawH: 48,
      ...
      // Nancy exterior blockers matched to the user red-line guide.
      // Top wall / fascia
      makeCollisionBox("nancysBlockRoofAndWall", 24, 5, 9, 2),
      // Front wall sections left and right of the recessed doorway
      makeCollisionBox("nancysBlockFrontUpperLeft", 24, 7, 4, 1),
      makeCollisionBox("nancysBlockFrontUpperRight", 29, 7, 4, 1),
      // Door row: only the actual doorway tile remains enterable
      makeCollisionBox("nancysBlockDoorRowLeft", 24, 8, 4, 1),
      makeCollisionBox("nancysBlockDoorRowRight", 29, 8, 4, 1),
      // Outer side rails / edge of the porch
      makeCollisionBox("nancysBlockPorchLeftEdge", 24, 9, 1, 2),
      makeCollisionBox("nancysBlockPorchRightEdge", 32, 9, 1, 2),
      // Front porch edge with a gap only at the central stair opening
      makeCollisionBox("nancysBlockPorchFrontLeft", 24, 10, 3, 1),
      makeCollisionBox("nancysBlockPorchFrontInnerLeft", 27, 10, 1, 1),
      makeCollisionBox("nancysBlockPorchFrontInnerRight", 29, 10, 1, 1),
      makeCollisionBox("nancysBlockPorchFrontRight", 30, 10, 3, 1),
      {
