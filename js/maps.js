  ...
  return {
    ...
    objects: [
      ...
      },
      {
        ...
        interaction: {
          type: "dialogue",
          text: "SIGN: Welcome to Nassau. Movement is now tile-based: one tap or key press moves one tile. Walk into the cave mouth to load the second map."
        }
      },
      {
        id: "palm01",
      ...
      },
      {
        ...
        interaction: {
          type: "dialogue",
          text: "A cave mouth. Walk into the lit entrance to load the cave map."
        }
      }
    ],
    npcs: [
      {
        ...
        drawH: 58,
        direction: "down",
        dialogue: "Arrr. This version now has four-direction tile movement, GP, HP, chests, and a pocket inventory."
      }
    ],
    portals: [
      {
...
function createCave01() {
  ...
  return {
    ...
    ground,
    spawns: {
      entrance: { tileX: 12, tileY: 13, direction: "up" }
    },
    objects: [
      {
        id: "exitSign",
      ...
      },
      {
        ...
        interaction: {
          ...
          title: "Damp Chest",
          emptyText: "The damp chest is empty. The spoon is now somebody else's problem.",
          loot: [
