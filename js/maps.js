...
function createNassau() {
  ...
  return {
    ...
    objects: [
      ...
      // Nancy exterior blockers based on the marked red guide.
      // Side approach columns remain walkable.
      // The row containing the doorway is blocked except for the actual entry tile.
      makeCollisionBox("nancysBlockRoofAndWall", 24, 5, 9, 2),
      makeCollisionBox("nancysBlockLeftCounter", 24, 7, 4, 1),
      makeCollisionBox("nancysBlockRightCounter", 29, 7, 4, 1),
