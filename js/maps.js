...
function createNassau() {
  ...
  // Walkable water under the decorative dock. It renders like water,
  // but does not block movement, so the player can walk over the dock art.
  paintRect(ground, 20, 22, 5, 6, "dockWater");
