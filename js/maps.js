  ...
  return {
    ...
    objects: [
      ...
      makeCollisionBox("hutBlockRight", 11, 20, 1, 1),
      {
        ...
        interaction: {
          type: "dialogue",
          text: "PLAQUE: The first hut on Nassau. Later this can become a shop, quest hub, tavern, or player home."
        }
      },
      {
        id: "campfire",
      ...
      },
      {
        ...
        interaction: {
          type: "dialogue",
          text: "SIGN: Walk through flower patches and you might find wheat or barley. Plant crops only on grass."
        }
      },
      {
      ...
      makeCollisionBox("nancysTavernBodyBlock", 24, 3, 9, 5),
      makeCollisionBox("nancysTavernLeftDeckBlock", 24, 8, 3, 2),
      makeCollisionBox("nancysTavernRightDeckBlock", 30, 8, 3, 2),
      makeCollisionBox("nancysTavernDoorFrameLeft", 27, 8, 1, 1),
      makeCollisionBox("nancysTavernDoorFrameRight", 29, 8, 1, 1),
      {
...
function createNancysTavern() {
  ...
  ground[height - 1][7] = "houseFloor";
  ground[height - 1][8] = "houseFloor";
  ...
  return {
    ...
    objects: [
      ...
      { id: "tavernTable01", sprite: "barrel", x: 3, y: 7, drawW: 48, drawH: 48, solid: true, hitbox: { x: 3, y: 7, w: 1, h: 1 }, interaction: { type: "dialogue", text: "A tavern table. Sticky, but structurally sound." } },
      { id: "tavernTable02", sprite: "barrel", x: 12, y: 7, drawW: 48, drawH: 48, solid: true, hitbox: { x: 12, y: 7, w: 1, h: 1 }, interaction: { type: "dialogue", text: "Another tavern table. This one has definitely heard secrets." } },
    ...
    npcs: [
      {
        ...
        standingSprites: {
          ...
          up: "nancyF04Up0",
          left: "nancyF04Left0",
          right: "nancyF04Right0"
        },
        anims: {
          down: ["nancyF04Down0", "nancyF04Down1", "nancyF04Down0", "nancyF04Down2"],
          up: ["nancyF04Up0", "nancyF04Up1", "nancyF04Up0", "nancyF04Up2"],
          left: ["nancyF04Left0", "nancyF04Left1", "nancyF04Left0", "nancyF04Left2"],
          right: ["nancyF04Right0", "nancyF04Right1", "nancyF04Right0", "nancyF04Right2"]
        },
