...
function createNassau() {
  ...
  return {
    ...
    objects: [
      ...
      // Side approach columns and the front deck are intentionally walkable.
      // Block the roof / wall / counter mass, while leaving the central door approach open.
      ...
      makeCollisionBox("nancysBlockLeftFrontDecor", 24, 8, 1, 1),
      makeCollisionBox("nancysBlockRightFrontDecor", 32, 8, 1, 1),
      {
    ...
    portals: [
      ...
      {
        id: "toNancysTavern",
        // Actual doorway tile: one tile higher than the stairs/deck approach.
        x: 28,
        y: 8,
        w: 1,
        h: 1,
...
function makeTavernBarObjects() {
  ...
  objects.push({ id: "barMug01", sprite: "tavernMug", x: 6.15, y: 3.45, drawW: 30, drawH: 30, solid: false });
  objects.push({ id: "barMug02", sprite: "tavernMug", x: 7.55, y: 3.45, drawW: 30, drawH: 30, solid: false });
  objects.push({ id: "barBottle01", sprite: "tavernBottle", x: 8.25, y: 3.45, drawW: 30, drawH: 30, solid: false });
...
function makeTavernTableSet(id, x, y) {
  return [
    ...
    { id: id + "_chairS", sprite: "tavernChairAlt", x, y: y + 1, drawW: 48, drawH: 48, solid: true, hitbox: { x, y: y + 1, w: 1, h: 1 } },
    { id: id + "_chairW", sprite: "tavernChair", x: x - 1, y, drawW: 48, drawH: 48, solid: true, hitbox: { x: x - 1, y, w: 1, h: 1 } },
    { id: id + "_mug", sprite: "tavernMug", x: x + 0.18, y: y - 0.08, drawW: 28, drawH: 28, solid: false }
  ];
}
