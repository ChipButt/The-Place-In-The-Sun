...
function createNassau() {
  ...
  // Mostly sand. Keep a small grass area inside the island only.
  paintEllipse(ground, 22, 14, 5, 3, "grass");
  paintRect(ground, 20, 13, 2, 2, "grassA");
  paintRect(ground, 23, 14, 2, 2, "grassB");
  paintRect(ground, 19, 16, 2, 1, "flowers");
  paintRect(ground, 25, 13, 2, 1, "flowers");
  ...
  return {
    ...
    objects: [
      ...
      makeCollisionBox("hutBlockTop", 27, 6, 4, 2),
      makeCollisionBox("hutBlockLeft", 27, 8, 1, 1),
      makeCollisionBox("hutBlockRight", 30, 8, 1, 1),
      {
        id: "hutPlaque",
        sprite: "sign",
        x: 31,
    ...
    npcs: [
      ...
      },
      {
        ...
        anims: {
          down: ["nancyDown0", "nancyDown1", "nancyDown0", "nancyDown2"],
          up: ["nancyUp0", "nancyUp1", "nancyUp0", "nancyUp2"],
          left: ["nancyLeft0", "nancyLeft1", "nancyLeft0", "nancyLeft2"],
          right: ["nancyRight0", "nancyRight1", "nancyRight0", "nancyRight2"]
        },
