  ...
  return {
    ...
    objects: [
      ...
      },
      {
        ...
        sortY: 12,
        roofOverlay: {
          // 9×9-grid-style triangle: roof/gable section drawn above the player.
          points: [
            { x: 0.95, y: 2.05 },
            { x: 4.5, y: 0.18 },
            { x: 8.05, y: 2.05 }
      ...
      // Nancy exterior blockers from the red-line markup.
      // Main building body: full visual width from row 2 to row 7, leaving only the lower stair approach open.
      makeCollisionBox("nancysTavernBodyBlock", 24, 5, 9, 4),
      makeCollisionBox("nancysTavernLeftDeckBlock", 24, 9, 3, 1),
      makeCollisionBox("nancysTavernRightDeckBlock", 30, 9, 3, 1),
      makeCollisionBox("nancysTavernDoorFrameLeft", 27, 9, 1, 1),
      makeCollisionBox("nancysTavernDoorFrameRight", 29, 9, 1, 1),
      {
...
function createNancysTavern() {
  ...
  return {
    ...
    objects: [
      // Decorative crops from the uploaded tavern interior asset sheet.
      { id: "nancysBackWallDecor", sprite: "nancysBarBackWall", x: 4.2, y: 0.2, drawW: 264, drawH: 171, solid: false },
      { id: "nancysFurnitureDecor", sprite: "nancysBarFurniture", x: 1.0, y: 4.3, drawW: 223, drawH: 137, solid: false },

      // Physical bar / blockers.
      { id: "barCounter01", sprite: "crate", x: 5, y: 4, drawW: 48, drawH: 48, solid: true, hitbox: { x: 5, y: 4, w: 1, h: 1 } },
      { id: "barCounter02", sprite: "crate", x: 6, y: 4, drawW: 48, drawH: 48, solid: true, hitbox: { x: 6, y: 4, w: 1, h: 1 } },
      { id: "barCounter03", sprite: "crate", x: 7, y: 4, drawW: 48, drawH: 48, solid: true, hitbox: { x: 7, y: 4, w: 1, h: 1 } },
      { id: "barCounter04", sprite: "crate", x: 8, y: 4, drawW: 48, drawH: 48, solid: true, hitbox: { x: 8, y: 4, w: 1, h: 1 } },
      { id: "barCounter05", sprite: "crate", x: 9, y: 4, drawW: 48, drawH: 48, solid: true, hitbox: { x: 9, y: 4, w: 1, h: 1 } },

      { id: "tavernTable01", sprite: "barrel", x: 3, y: 8, drawW: 48, drawH: 48, solid: true, hitbox: { x: 3, y: 8, w: 1, h: 1 }, interaction: { type: "dialogue", text: "A tavern table. Sticky, but structurally sound." } },
      { id: "tavernTable02", sprite: "barrel", x: 12, y: 8, drawW: 48, drawH: 48, solid: true, hitbox: { x: 12, y: 8, w: 1, h: 1 }, interaction: { type: "dialogue", text: "Another tavern table. This one has definitely heard secrets." } },
      { id: "tavernStorage01", sprite: "barrel", x: 2, y: 2, drawW: 48, drawH: 48, solid: true, hitbox: { x: 2, y: 2, w: 1, h: 1 } },
      { id: "tavernStorage02", sprite: "barrel", x: 13, y: 2, drawW: 48, drawH: 48, solid: true, hitbox: { x: 13, y: 2, w: 1, h: 1 } },
      ...
      // Invisible walls so the room still feels enclosed.
