export const IMAGE_PATHS = {
  ...
  dockCustom: "assets/images/props/dock.png",
  walkableDock: "assets/images/props/walkable_dock.png",
...
function derekFrame(col, row) {
  return { image: "derekNormalbeard", sx: col * 48, sy: row * 48, sw: 48, sh: 48 };
}
...
const derekNormalbeard = {
  ...
  frames: {
    ...
    derekLeft0: derekFrame(1, 1),
    derekLeft1: derekFrame(0, 1),
    derekLeft2: derekFrame(2, 1),
    derekRight0: derekFrame(1, 2),
    derekRight1: derekFrame(0, 2),
    derekRight2: derekFrame(2, 2),
    derekDown0: derekFrame(1, 3),
    derekDown1: derekFrame(0, 3),
    derekDown2: derekFrame(2, 3)
  }
};
...
export const SPRITES = {
  ...
  walkableDock: { image: "walkableDock" },
