...
export const SPRITES = {
  ...
  // Crop stages are drawn as single-tile replacements, not oversized overlays.
  // The source rectangles are cropped from the field strips but rendered back to one tile.
  wheatCrop0: sprite("fields", 185, 430, 320, 80),
  wheatCrop1: sprite("fields", 185, 980, 320, 95),
  wheatCrop2: sprite("fields", 185, 1130, 320, 95),
  wheatCrop3: sprite("fields", 185, 1290, 320, 105),
  wheatCrop4: sprite("fields", 185, 1660, 320, 135),
  wheatCrop: sprite("fields", 185, 1660, 320, 135),
  barleyCrop0: sprite("fields", 185, 430, 320, 80),
  barleyCrop1: sprite("fields", 185, 980, 320, 95),
  barleyCrop2: sprite("fields", 185, 1130, 320, 95),
  barleyCrop3: sprite("fields", 185, 1290, 320, 105),
  barleyCrop4: sprite("fields", 185, 620, 320, 95),
  barleyCrop: sprite("fields", 185, 620, 320, 95),
  egg: { image: "eggIcon", sx: 0, sy: 0, sw: 32, sh: 32 },
  nancysTavern: { image: "nancysTavern" },
  tavernWall: tile("nancysBarAssets", 0, 0),
  tavernWallAlt: tile("nancysBarAssets", 1, 0),
  tavernBarFront: tile("nancysBarAssets", 4, 9),
  tavernBarTop: tile("nancysBarAssets", 4, 8),
  tavernChair: tile("nancysBarAssets", 7, 10),
  tavernTable: tile("nancysBarAssets", 10, 10),
  tavernMug: tile("nancysBarAssets", 11, 11),
  tavernBottle: tile("nancysBarAssets", 13, 11),
  tavernDoor: tile("nancysBarAssets", 6, 0),
  tavernCrate: tile("nancysBarAssets", 16, 17),
  tavernStove: tile("nancysBarAssets", 0, 17),
  ...
  nancyF04South: f04Frame(1, 0),
  nancyF04Down0: f04Frame(1, 0),
  nancyF04Down1: f04Frame(0, 0),
  nancyF04Down2: f04Frame(2, 0),
  nancyF04Left0: f04Frame(1, 1),
  nancyF04Left1: f04Frame(0, 1),
  nancyF04Left2: f04Frame(2, 1),
  nancyF04Right0: f04Frame(1, 1),
  nancyF04Right1: f04Frame(2, 1),
  nancyF04Right2: f04Frame(3, 1),
  nancyF04Up0: f04Frame(1, 2),
  nancyF04Up1: f04Frame(0, 2),
  ...
  citizenDown0: m05Frame(1, 0),
  citizenDown1: m05Frame(0, 0),
  citizenDown2: m05Frame(2, 0),
  citizenLeft0: m05Frame(1, 1),
  citizenLeft1: m05Frame(0, 1),
  citizenLeft2: m05Frame(2, 1),
  citizenRight0: m05Frame(1, 1),
  citizenRight1: m05Frame(2, 1),
  citizenRight2: m05Frame(3, 1),
  citizenUp0: m05Frame(1, 2),
  citizenUp1: m05Frame(0, 2),
