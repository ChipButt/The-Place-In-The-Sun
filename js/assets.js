...
export const SPRITES = {
  ...
  grass: tile("basictiles", 3, 1),
  grassBlock: tile("basictiles", 3, 1),
  tallGrass: tile("basictiles", 1, 8),
  sand: tile("basictiles", 2, 1),
  dirt: tile("basictiles", 0, 9),
  stone: tile("basictiles", 0, 0),
  water: tile("basictiles", 5, 6),
  shallowWater: tile("basictiles", 5, 6),
  ...
  crate: tile("basictiles", 6, 8),
  barrel: tile("basictiles", 3, 3),
  chest: tile("things", 6, 0),
  chestOpen: tile("things", 6, 2),
