export const IMAGE_PATHS = {
  ...
  sandPlainCustom: "assets/images/terrain/sand.png",
  sandShellCustom: "assets/images/terrain/sand_shells.png",
  grassShortCustom: "assets/images/terrain/short_grass.png",
  grassTallFrame1: "assets/images/terrain/tall_grass_1.png",
  grassTallFrame2: "assets/images/terrain/tall_grass_2.png",
  grassTallFrame3: "assets/images/terrain/tall_grass_3.png",
  shoreNorth: "assets/images/terrain/shore_n.png",
  shoreEast: "assets/images/terrain/shore_e.png",
  shoreSouth: "assets/images/terrain/shore_s.png",
  shoreWest: "assets/images/terrain/shore_w.png",
  shoreNorthWest: "assets/images/terrain/shore_nw.png",
  shoreNorthEast: "assets/images/terrain/shore_ne.png",
  shoreSouthEast: "assets/images/terrain/shore_se.png",
  shoreSouthWest: "assets/images/terrain/shore_sw.png",
  flowersSubtle: "assets/images/terrain/flowers.png",
  flowersLarge: "assets/images/terrain/flowers.png",
  palmTreeCustom: "assets/images/props/palm_tree.png",
  dockCustom: "assets/images/props/main_dock_v47.png",
  mainDock: "assets/images/props/main_dock_v47.png",
  waterFrame1: "assets/images/water/water_1.png",
  waterFrame2: "assets/images/water/water_2.png",
  waterFrame3: "assets/images/water/water_3.png",
  firstHouseDock: "assets/images/buildings/first_house_dock.png",
  shoreSheet1: "assets/images/terrain/shoreline_anim_1.png",
  shoreSheet2: "assets/images/terrain/shoreline_anim_2.png",
  shoreSheet3: "assets/images/terrain/shoreline_anim_3.png",
  derekNormalbeard: "assets/images/characters/derek_normalbeard.png"
};
...
function shoreFrame(frame, col, row) {
  return { image: `shoreSheet${frame}`, sx: col * 96, sy: row * 96, sw: 96, sh: 96 };
}

function derekFrame(col, row, extra = {}) {
  return { image: "derekNormalbeard", sx: col * 48, sy: row * 48, sw: 48, sh: 48, ...extra };
}

const derekSmallFaceScale = { drawScale: 0.875 };

const derekNormalbeard = {
  id: "derek_normalbeard",
  name: "Derek Normalbeard",
  portrait: "derekDown0",
  anims: {
    down: ["derekDown0", "derekDown1", "derekDown0", "derekDown2"],
    left: ["derekLeft0", "derekLeft1", "derekLeft0", "derekLeft2"],
    right: ["derekRight0", "derekRight1", "derekRight0", "derekRight2"],
    up: ["derekUp0", "derekUp1", "derekUp0", "derekUp2"]
  },
  frames: {
    derekUp0: derekFrame(1, 0),
    derekUp1: derekFrame(0, 0),
    derekUp2: derekFrame(2, 0),
    derekLeft0: derekFrame(1, 1, derekSmallFaceScale),
    derekLeft1: derekFrame(0, 1, derekSmallFaceScale),
    derekLeft2: derekFrame(2, 1, derekSmallFaceScale),
    derekRight0: derekFrame(1, 2, derekSmallFaceScale),
    derekRight1: derekFrame(0, 2, derekSmallFaceScale),
    derekRight2: derekFrame(2, 2, derekSmallFaceScale),
    derekDown0: derekFrame(1, 3, derekSmallFaceScale),
    derekDown1: derekFrame(0, 3, derekSmallFaceScale),
    derekDown2: derekFrame(2, 3, derekSmallFaceScale)
  }
};
...
export const SPRITES = {
  ...
  waterFrame1: { image: "waterFrame1" },
  waterFrame2: { image: "waterFrame2" },
  waterFrame3: { image: "waterFrame3" },
  water: { image: "waterFrame1" },
  shallowWater: { image: "waterFrame1" },

  grass: { image: "grassShortCustom" },
  grassA: { image: "grassTallFrame1" },
  grassB: { image: "grassTallFrame1" },
  grassBlock: { image: "grassShortCustom" },
  tallGrassFrame1: { image: "grassTallFrame1" },
  tallGrassFrame2: { image: "grassTallFrame2" },
  tallGrassFrame3: { image: "grassTallFrame3" },
  tallGrass: { image: "grassTallFrame1" },

  sand: { image: "sandPlainCustom" },
  sandShell: { image: "sandShellCustom" },
  shoreNorth: { image: "shoreNorth" },
  shoreEast: { image: "shoreEast" },
  shoreSouth: { image: "shoreSouth" },
  shoreWest: { image: "shoreWest" },
  shoreNorthWest: { image: "shoreNorthWest" },
  shoreNorthEast: { image: "shoreNorthEast" },
  shoreSouthEast: { image: "shoreSouthEast" },
  shoreSouthWest: { image: "shoreSouthWest" },
  shoreNorth1: shoreFrame(1, 0, 0),
  shoreEast1: shoreFrame(1, 1, 0),
  shoreSouth1: shoreFrame(1, 2, 0),
  shoreWest1: shoreFrame(1, 3, 0),
  shoreNorthWest1: shoreFrame(1, 0, 1),
  shoreNorthEast1: shoreFrame(1, 1, 1),
  shoreSouthEast1: shoreFrame(1, 2, 1),
  shoreSouthWest1: shoreFrame(1, 3, 1),
  shoreInnerNorthWest1: shoreFrame(1, 0, 2),
  shoreInnerNorthEast1: shoreFrame(1, 1, 2),
  shoreInnerSouthEast1: shoreFrame(1, 2, 2),
  shoreInnerSouthWest1: shoreFrame(1, 3, 2),
  shoreNorthSouth1: shoreFrame(1, 0, 3),
  shoreEastWest1: shoreFrame(1, 1, 3),
  shoreWaterCenter1: shoreFrame(1, 2, 3),
  shoreSandCenter1: shoreFrame(1, 3, 3),

  shoreNorth2: shoreFrame(2, 0, 0),
  shoreEast2: shoreFrame(2, 1, 0),
  shoreSouth2: shoreFrame(2, 2, 0),
  shoreWest2: shoreFrame(2, 3, 0),
  shoreNorthWest2: shoreFrame(2, 0, 1),
  shoreNorthEast2: shoreFrame(2, 1, 1),
  shoreSouthEast2: shoreFrame(2, 2, 1),
  shoreSouthWest2: shoreFrame(2, 3, 1),
  shoreInnerNorthWest2: shoreFrame(2, 0, 2),
  shoreInnerNorthEast2: shoreFrame(2, 1, 2),
  shoreInnerSouthEast2: shoreFrame(2, 2, 2),
  shoreInnerSouthWest2: shoreFrame(2, 3, 2),
  shoreNorthSouth2: shoreFrame(2, 0, 3),
  shoreEastWest2: shoreFrame(2, 1, 3),
  shoreWaterCenter2: shoreFrame(2, 2, 3),
  shoreSandCenter2: shoreFrame(2, 3, 3),

  shoreNorth3: shoreFrame(3, 0, 0),
  shoreEast3: shoreFrame(3, 1, 0),
  shoreSouth3: shoreFrame(3, 2, 0),
  shoreWest3: shoreFrame(3, 3, 0),
  shoreNorthWest3: shoreFrame(3, 0, 1),
  shoreNorthEast3: shoreFrame(3, 1, 1),
  shoreSouthEast3: shoreFrame(3, 2, 1),
  shoreSouthWest3: shoreFrame(3, 3, 1),
  shoreInnerNorthWest3: shoreFrame(3, 0, 2),
  shoreInnerNorthEast3: shoreFrame(3, 1, 2),
  shoreInnerSouthEast3: shoreFrame(3, 2, 2),
  shoreInnerSouthWest3: shoreFrame(3, 3, 2),
  shoreNorthSouth3: shoreFrame(3, 0, 3),
  shoreEastWest3: shoreFrame(3, 1, 3),
  shoreWaterCenter3: shoreFrame(3, 2, 3),
  shoreSandCenter3: shoreFrame(3, 3, 3),
  ...
  boat: { image: "mainDock" },
  mainDock: { image: "mainDock" },
  walkableDock: { image: "mainDock" },
  house: { image: "firstHouseDock" },
  ...
  flowersSubtle: { image: "flowersSubtle" },
  flowersLarge: { image: "flowersLarge" },
  flowers: { image: "flowersSubtle" },
  ...
  nancyF04Left0: f04Frame(3, 0),
  nancyF04Left1: f04Frame(3, 1),
  nancyF04Left2: f04Frame(3, 2),
  nancyF04Right0: f04Frame(1, 0),
  nancyF04Right1: f04Frame(1, 1),
  nancyF04Right2: f04Frame(1, 2),
  nancyF04Up0: f04Frame(2, 0),
  nancyF04Up1: f04Frame(2, 1),
  nancyF04Up2: f04Frame(2, 2),
  ...
  citizenLeft0: m05Frame(3, 0),
  citizenLeft1: m05Frame(3, 1),
  citizenLeft2: m05Frame(3, 2),
  citizenRight0: m05Frame(1, 0),
  citizenRight1: m05Frame(1, 1),
  citizenRight2: m05Frame(1, 2),
  citizenUp0: m05Frame(2, 0),
  citizenUp1: m05Frame(2, 1),
  citizenUp2: m05Frame(2, 2),
...
export const CHARACTER_SETS = {
  ...
  derek_normalbeard: {
    id: derekNormalbeard.id,
    name: derekNormalbeard.name,
    portrait: derekNormalbeard.portrait,
    anims: derekNormalbeard.anims
  }
};
